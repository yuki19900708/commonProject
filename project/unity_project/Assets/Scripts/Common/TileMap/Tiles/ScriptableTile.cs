...
namespace Universal.TileMapping
{
    public abstract class ScriptableTile : ScriptableObject
    {
        ...
        public abstract GameObject GetTile(TileMap tileMap = null, Point position = default(Point));

        public abstract Texture2D GetPreview();

        public abstract int GetTileIndex(TileMap tileMap = null, Point position = default(Point));
