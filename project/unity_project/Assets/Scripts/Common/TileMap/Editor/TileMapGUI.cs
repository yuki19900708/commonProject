...
{
    public static class TileMapGUILayout
    {
        ...
        {
            Rect position = GUILayoutUtility.GetRect(GUIContent.none, TileMapGUIStyles.splitter, GUILayout.Height(thickness));

            if (Event.current.type == EventType.Repaint)
            {
                Color restoreColor = UnityEngine.GUI.color;
                GUI.color = rgb;
                TileMapGUIStyles.splitter.Draw(position, false, false, false, false);
        ...
        {
            Splitter(thickness, TileMapGUIStyles.splitter);
        }
    ...
    public static class TileMapGUI
    {
        private static readonly Color splitterColor = EditorGUIUtility.isProSkin ? new Color(0.157f, 0.157f, 0.157f) : new Color(0.5f, 0.5f, 0.5f);
        // GUI Style
    ...
    public static class TileMapGUIStyles
    {
