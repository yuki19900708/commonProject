...
public class InlineText : Text, IPointerClickHandler
{
    ...
    public bool LinkUnderline = false;
    #region 超链接
    //[System.Serializable]
    ...
    public static string GetExpressionString(int id, string expressionName)
    {
        return string.Format("[{0}#{1}]", id, expressionName);
    }
    /// <summary>
    /// 获取表情超链接String
    /// </summary>
    /// <param name="id"></param>
    /// <param name="emoticonName"></param>
    public static string GetExpressionString(string linkName)
    {
        return string.Format("[-1#{0}]", linkName);
    }
